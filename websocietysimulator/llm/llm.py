...
import openai
class MyLLM(LLMBase):
    def __init__(self, port: str = "38194", model: str = "Qwen/Qwen3-4B-Instruct-2507"):
        """
        Initialize My LLM
        ...
        """
        super().__init__(model)
        # python3 -m sglang.launch_server --model-path Qwen/Qwen3-4B-Instruct-2507 --host 0.0.0.0 --log-level warning --port 12345
